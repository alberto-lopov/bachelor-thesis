...
test_sentences = read_datasets([TEST_1, TEST_2, TEST_3, TEST_4, TEST_5])
...
# Uncomment this if you want to calculate perplexity based on MLE (Maximun likelihood estimate)
