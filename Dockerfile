...
# docker build -t="arangodb/bachelor-thesis" .
...
# docker run -d -p 8529:8529 -v C:\Users\Alberto_Work\Desktop\TFG\bachelorThesis\data-db:/var/lib/arangodb3 --name arango_bachelorThesis arangodb/bachelor-thesis